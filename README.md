...
Try [Fetch Inject on CodePen](https://codepen.io/jhabdas/pen/MpVeOE?editors=0012) while referencing the [Use Cases](#use-cases) to enhance your understanding of what this library can do for you.
